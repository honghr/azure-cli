...
def pytest_addoption(parser):
    ...
    parser.addoption("--mysql-general-purpose-sku", action="store", default="Standard_D2ds_v4")
    parser.addoption("--mysql-memory-optimized-sku", action="store", default="Standard_E2ds_v4")
